...
typedef enum { TYPE_NONE=0, TYPE_TIMEOUT_DEFAULT=1, TYPE_TIMEOUT_SHORT=2, TYPE_INTERMISSION=3 } TimerType;
...
const TimerInfo TIMER_STANDBY = { TYPE_NONE, STATE_STANDBY, TIMER_ZERO, false, "STANDBY" };
const TimerInfo TIMER_STOPPED_TIMEOUT_DEFAULT = { TYPE_TIMEOUT_DEFAULT, STATE_STOPPED, TIMER_ZERO, false, "TIMEOUT STOPPED" };
const TimerInfo TIMER_RUNNING_TIMEOUT_DEFAULT = { TYPE_TIMEOUT_DEFAULT, STATE_RUNNING, TIMER_TIMEOUT_DEFAULT, true, "TIMEOUT RUNNING" };
const TimerInfo TIMER_EXPIRED_TIMEOUT_DEFAULT = { TYPE_TIMEOUT_DEFAULT, STATE_EXPIRED, TIMER_ZERO, false, "TIMEOUT EXPIRED" };
const TimerInfo TIMER_STOPPED_TIMEOUT_SHORT = { TYPE_TIMEOUT_SHORT, STATE_STOPPED, TIMER_ZERO, false, "30'' TO STOPPED" };
const TimerInfo TIMER_RUNNING_TIMEOUT_SHORT = { TYPE_TIMEOUT_SHORT, STATE_RUNNING, TIMER_TIMEOUT_SHORT, true, "30'' TO RUNNING" };
const TimerInfo TIMER_EXPIRED_TIMEOUT_SHORT = { TYPE_TIMEOUT_SHORT, STATE_EXPIRED, TIMER_ZERO, false, "30'' TO EXPIRED" };
const TimerInfo TIMER_STOPPED_INTERMISSION = { TYPE_INTERMISSION, STATE_STOPPED, TIMER_ZERO, false, "1' IM STOPPED" };
const TimerInfo TIMER_RUNNING_INTERMISSION = { TYPE_INTERMISSION, STATE_RUNNING, TIMER_INTERMISSION, true, "1' IM RUNNING" };
const TimerInfo TIMER_EXPIRED_INTERMISSION = { TYPE_INTERMISSION, STATE_EXPIRED, TIMER_ZERO, false, "1' IM EXPIRED" };
